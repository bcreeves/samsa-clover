<template>
    <nb-container :style="{ backgroundColor: '#fff' }">
        <nb-header>
            ...
            <nb-body>
                <nb-title>SAMSA Inc.</nb-title>
            </nb-body>
            <nb-right />
        </nb-header>
        <nb-content :style="{flex: 1, backgroundColor: '#ddd'}">
            <view class="home-content">
                <nb-button iconRight :onPress="() => pay()" :style="{alignSelf: 'flex-end'}">
...
//             // );
//             cloverDeviceConnectionConfiguration = getDeviceConfigurationForNetwork(
...
//                 builderConfiguration
//             );
//             cloverConnector = cloverConnectorFactory.createICloverConnector(
...
//         config["endpoint"] = "https://localhost:12345/remote_pay";
...
//                     // updateStatus(
//                     //     "Your Clover device is ready to process requests.",
//                     //     true
//                     // );
...
//                     // updateStatus(
//                     //     "The connection to your Clover Device has been dropped.",
//                     //     false
//                     // );
...
export default {
    ...
    methods: {
        ...
        // showMessage: function() {
        //     PayInvoice().showMessage();
        // },
        pay: function() {
            // PayInvoice().performSale();
            PayInvoice.makePayment();
        },
        // resetDevice: function() {
        //     PayInvoice().resetDevice();
        // }
    }
};
</script>
